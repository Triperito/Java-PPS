...
public class FramePrincipal extends JFrame {
	...
	ImageIcon Cerrar = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/ImagenFondo.png"));
	ImageIcon CerrarMod = new ImageIcon(Cerrar.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));

	/* -- BOTONES (VENTANA PRINCIPAL) -- */
	ImageIcon APrincipal = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnPrA.png"));
	ImageIcon APrincipalMod = new ImageIcon(APrincipal.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));
	ImageIcon APrincipalCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnPrClickeadoA.png"));
	ImageIcon APrincipalModCliked = new ImageIcon(APrincipalCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon FPrincipal = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnPrF.png"));
	ImageIcon FPrincipalMod = new ImageIcon(FPrincipal.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));
	ImageIcon FPrincipalCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnPrClickeadoF.png"));
	ImageIcon FPrincipalModCliked = new ImageIcon(FPrincipalCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon KPrincipal = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnPrK.png"));
	ImageIcon KPrincipalMod = new ImageIcon(KPrincipal.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));
	ImageIcon KPrincipalCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnPrClickeadoK.png"));
	ImageIcon KPrincipalModCliked = new ImageIcon(KPrincipalCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon OPrincipal = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnPrO.png"));
	ImageIcon OPrincipalMod = new ImageIcon(OPrincipal.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));
	ImageIcon OPrincipalCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnPrClickeadoO.png"));
	ImageIcon OPrincipalModCliked = new ImageIcon(OPrincipalCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon TPrincipal = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnPrT.png"));
	ImageIcon TPrincipalMod = new ImageIcon(TPrincipal.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));
	ImageIcon TPrincipalCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnPrClickeadoT.png"));
	ImageIcon TPrincipalModCliked = new ImageIcon(TPrincipalCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	/* -- BOTONES VENTANA A -- */
	ImageIcon BotonA = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnA.png"));
	ImageIcon BotonAMod = new ImageIcon(BotonA.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonACliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoA.png"));
	ImageIcon BotonAModCliked = new ImageIcon(BotonACliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonB = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnB.png"));
	ImageIcon BotonBMod = new ImageIcon(BotonB.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonBCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoB.png"));
	ImageIcon BotonBModCliked = new ImageIcon(BotonBCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonC = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnC.png"));
	ImageIcon BotonCMod = new ImageIcon(BotonC.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonCCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoC.png"));
	ImageIcon BotonCModCliked = new ImageIcon(BotonCCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonD = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnD.png"));
	ImageIcon BotonDMod = new ImageIcon(BotonD.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonDCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoD.png"));
	ImageIcon BotonDModCliked = new ImageIcon(BotonDCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonE = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnE.png"));
	ImageIcon BotonEMod = new ImageIcon(BotonE.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonECliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoE.png"));
	ImageIcon BotonEModCliked = new ImageIcon(BotonECliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	/* -- BOTONES VENTANA F -- */
	ImageIcon BotonF = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnF.png"));
	ImageIcon BotonFMod = new ImageIcon(BotonF.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonFCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoF.png"));
	ImageIcon BotonFModCliked = new ImageIcon(BotonFCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonG = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnG.png"));
	ImageIcon BotonGMod = new ImageIcon(BotonG.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonGCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoG.png"));
	ImageIcon BotonGModCliked = new ImageIcon(BotonGCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonH = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnH.png"));
	ImageIcon BotonHMod = new ImageIcon(BotonH.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonHCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoH.png"));
	ImageIcon BotonHModCliked = new ImageIcon(BotonHCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonI = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnI.png"));
	ImageIcon BotonIMod = new ImageIcon(BotonI.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonICliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoI.png"));
	ImageIcon BotonIModCliked = new ImageIcon(BotonICliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonJ = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnJ.png"));
	ImageIcon BotonJMod = new ImageIcon(BotonJ.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonJCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoJ.png"));
	ImageIcon BotonJModCliked = new ImageIcon(BotonJCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	/* -- BOTONES VENTANA K -- */
	ImageIcon BotonK = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnK.png"));
	ImageIcon BotonKMod = new ImageIcon(BotonK.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonKCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoK.png"));
	ImageIcon BotonKModCliked = new ImageIcon(BotonKCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonL = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnL.png"));
	ImageIcon BotonLMod = new ImageIcon(BotonL.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonLCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoL.png"));
	ImageIcon BotonLModCliked = new ImageIcon(BotonLCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonM = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnM.png"));
	ImageIcon BotonMMod = new ImageIcon(BotonM.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonMCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoM.png"));
	ImageIcon BotonMModCliked = new ImageIcon(BotonMCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonN = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnN.png"));
	ImageIcon BotonNMod = new ImageIcon(BotonN.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonNCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoN.png"));
	ImageIcon BotonNModCliked = new ImageIcon(BotonNCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonNi = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnNi.png"));
	ImageIcon BotonNiMod = new ImageIcon(BotonNi.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonNiCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoNi.png"));
	ImageIcon BotonNiModCliked = new ImageIcon(BotonNiCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	/* -- BOTONES VENTANA O -- */
	ImageIcon BotonO = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnO.png"));
	ImageIcon BotonOMod = new ImageIcon(BotonO.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonOCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoO.png"));
	ImageIcon BotonOModCliked = new ImageIcon(BotonOCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonP = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnP.png"));
	ImageIcon BotonPMod = new ImageIcon(BotonP.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonPCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoP.png"));
	ImageIcon BotonPModCliked = new ImageIcon(BotonPCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonQU = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnQu.png"));
	ImageIcon BotonQUMod = new ImageIcon(BotonQU.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonQUCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoQu.png"));
	ImageIcon BotonQUModCliked = new ImageIcon(BotonQUCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonR = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnR.png"));
	ImageIcon BotonRMod = new ImageIcon(BotonR.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonRCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoR.png"));
	ImageIcon BotonRModCliked = new ImageIcon(BotonRCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonS = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnS.png"));
	ImageIcon BotonSMod = new ImageIcon(BotonS.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonSCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoS.png"));
	ImageIcon BotonSModCliked = new ImageIcon(BotonSCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	/* -- BOTONES VENTANA T -- */
	ImageIcon BotonT = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnT.png"));
	ImageIcon BotonTMod = new ImageIcon(BotonT.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonTCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoT.png"));
	ImageIcon BotonTModCliked = new ImageIcon(BotonTCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonU = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnU.png"));
	ImageIcon BotonUMod = new ImageIcon(BotonU.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonUCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoU.png"));
	ImageIcon BotonUModCliked = new ImageIcon(BotonUCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonV = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnV.png"));
	ImageIcon BotonVMod = new ImageIcon(BotonV.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonVCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoV.png"));
	ImageIcon BotonVModCliked = new ImageIcon(BotonVCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonX = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnX.png"));
	ImageIcon BotonXMod = new ImageIcon(BotonX.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonXCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoX.png"));
	ImageIcon BotonXModCliked = new ImageIcon(BotonXCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	ImageIcon BotonY = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnY.png"));
	ImageIcon BotonYMod = new ImageIcon(BotonY.getImage().getScaledInstance(
			(int) (this.ancho * 0.21), (int) (this.alto * 0.25),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonYCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoY.png"));
	ImageIcon BotonYModCliked = new ImageIcon(BotonYCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.21),
					(int) (this.alto * 0.25), java.awt.Image.SCALE_DEFAULT));

	/* -- BOTON ESPACIO -- */
	ImageIcon BotonEspacio = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnEspacio.png"));
	ImageIcon BotonEspacioMod = new ImageIcon(BotonEspacio.getImage()
			.getScaledInstance((int) (this.ancho * 0.4),
					(int) (this.alto * 0.1), java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonEspacioCliked = new ImageIcon(
			FramePrincipal.class
					.getResource("/Graficos/BttnClickeadoEspacio.png"));
	ImageIcon BotonEspacioModCliked = new ImageIcon(BotonEspacioCliked
			.getImage().getScaledInstance((int) (this.ancho * 0.4),
					(int) (this.alto * 0.1), java.awt.Image.SCALE_DEFAULT));

	/* -- BOTON PUNTO -- */
	ImageIcon BotonPunto = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnPunto.png"));
	ImageIcon BotonPuntoMod = new ImageIcon(BotonPunto.getImage()
			.getScaledInstance((int) (this.ancho * 0.11),
					(int) (this.alto * 0.14), java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonPuntoCliked = new ImageIcon(
			FramePrincipal.class
					.getResource("/Graficos/BttnClickeadoPunto.png"));
	ImageIcon BotonPuntoModCliked = new ImageIcon(BotonPuntoCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.11),
					(int) (this.alto * 0.14), java.awt.Image.SCALE_DEFAULT));

	/* -- BOTON BORRAR -- */
	ImageIcon BotonBorrar = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnBorrar.png"));
	ImageIcon BotonBorrarMod = new ImageIcon(BotonBorrar.getImage()
			.getScaledInstance((int) (this.ancho * 0.11),
					(int) (this.alto * 0.14), java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonBorrarCliked = new ImageIcon(
			FramePrincipal.class
					.getResource("/Graficos/BttnClickeadoBorrar.png"));
	ImageIcon BotonBorrarModCliked = new ImageIcon(BotonBorrarCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.11),
					(int) (this.alto * 0.14), java.awt.Image.SCALE_DEFAULT));

	/* -- BOTON SI -- */
	ImageIcon BotonSI = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnSI.png"));
	ImageIcon BotonSIMod = new ImageIcon(BotonSI.getImage().getScaledInstance(
			(int) (this.ancho * 0.11), (int) (this.alto * 0.14),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonSICliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoSI.png"));
	ImageIcon BotonSIModCliked = new ImageIcon(BotonSICliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.11),
					(int) (this.alto * 0.14), java.awt.Image.SCALE_DEFAULT));

	/* -- BOTON NO -- */
	ImageIcon BotonNO = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnNO.png"));
	ImageIcon BotonNOMod = new ImageIcon(BotonNO.getImage().getScaledInstance(
			(int) (this.ancho * 0.11), (int) (this.alto * 0.14),
			java.awt.Image.SCALE_DEFAULT));
	ImageIcon BotonNOCliked = new ImageIcon(
			FramePrincipal.class.getResource("/Graficos/BttnClickeadoNO.png"));
	ImageIcon BotonNOModCliked = new ImageIcon(BotonNOCliked.getImage()
			.getScaledInstance((int) (this.ancho * 0.11),
					(int) (this.alto * 0.14), java.awt.Image.SCALE_DEFAULT));
	...
	public FramePrincipal() {
		...
		setUndecorated(true); // OCULTA EL TITULO DE LA VENTANA Y LA BARRA DE
								// TAREAS DE WINDOWS (QUEDA LA PANTALLA LIMPIA)
	...
	public void VentanaPrincipalConstructor() {
		...
		BttnPrA.setBounds((int) (this.ancho * 0.003),
				(int) (this.alto * 0.003), (int) (this.ancho * 0.21),
				(int) (this.alto * 0.25));
		...
		BttnPrF.setBounds((int) (this.ancho * 0.789),
				(int) (this.alto * 0.003), (int) (this.ancho * 0.21),
				(int) (this.alto * 0.25));
		...
		BttnPrK.setBounds((int) (this.ancho * 0.393),
				(int) (this.alto * 0.375), (int) (this.ancho * 0.21),
				(int) (this.alto * 0.25));
		...
		BttnPrO.setBounds((int) (this.ancho * 0.003),
				(int) (this.alto * 0.747), (int) (this.ancho * 0.21),
				(int) (this.alto * 0.25));
		...
		BttnPrT.setBounds((int) (this.ancho * 0.789),
				(int) (this.alto * 0.747), (int) (this.ancho * 0.21),
				(int) (this.alto * 0.25));
		...
		BttnPrEspacio.setBounds((int) (this.ancho * 0.3),
				(int) (this.alto * 0.003), (int) (this.ancho * 0.4),
				(int) (this.alto * 0.1));
		...
		BttnPrPunto.setBounds((int) (this.ancho * 0.003),
				(int) (this.alto * 0.43), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		BttnPrBorrar.setBounds((int) (this.ancho * 0.889),
				(int) (this.alto * 0.43), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		BttnPrSI.setBounds((int) (this.ancho * 0.293),
				(int) (this.alto * 0.717), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		BttnPrNO.setBounds((int) (this.ancho * 0.597),
				(int) (this.alto * 0.717), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		BttnClose1.setBounds((int) (this.ancho * 0.643),
				(int) (this.alto * 0.375), (int) (this.ancho * 0.21),
				(int) (this.alto * 0.25));
		...
		BttnClose2.setBounds((int) (this.ancho * 0.143),
				(int) (this.alto * 0.375), (int) (this.ancho * 0.21),
				(int) (this.alto * 0.25));
		...
		scrollPanePr.setBounds((int) (this.ancho * 0.25),
				(int) (this.alto * 0.879), (int) (this.ancho * 0.5),
				(int) (this.alto * 0.12));
		...
		txt.setBounds((int) (this.ancho * 0.25), (int) (this.alto * 0.879),
				(int) (this.ancho * 0.5), (int) (this.alto * 0.12));
	...
	public void VentanaAConstructor() {
		...
		BttnA.setBounds((int) (this.ancho * 0.003), (int) (this.alto * 0.003),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaA.add(BttnA);
		...
		BttnB.setBounds((int) (this.ancho * 0.789), (int) (this.alto * 0.003),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaA.add(BttnB);
		...
		BttnC.setBounds((int) (this.ancho * 0.393), (int) (this.alto * 0.375),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaA.add(BttnC);
		...
		BttnD.setBounds((int) (this.ancho * 0.003), (int) (this.alto * 0.747),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaA.add(BttnD);
		...
		BttnE.setBounds((int) (this.ancho * 0.789), (int) (this.alto * 0.747),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaA.add(BttnE);
		...
		BttnAEspacio.setBounds((int) (this.ancho * 0.3),
				(int) (this.alto * 0.003), (int) (this.ancho * 0.4),
				(int) (this.alto * 0.1));
		...
		BttnAPunto.setBounds((int) (this.ancho * 0.003),
				(int) (this.alto * 0.43), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		BttnABorrar.setBounds((int) (this.ancho * 0.889),
				(int) (this.alto * 0.43), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		BttnASI.setBounds((int) (this.ancho * 0.293),
				(int) (this.alto * 0.717), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		BttnANO.setBounds((int) (this.ancho * 0.597),
				(int) (this.alto * 0.717), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		scrollPaneA
				.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		scrollPaneA.setBounds((int) (this.ancho * 0.25),
				(int) (this.alto * 0.879), (int) (this.ancho * 0.5),
				(int) (this.alto * 0.12));
		...
		txtA.setBounds((int) (this.ancho * 0.25), (int) (this.alto * 0.879),
				(int) (this.ancho * 0.5), (int) (this.alto * 0.12));
	...
	public void VentanaFConstructor() {
		...
		BttnF.setBounds((int) (this.ancho * 0.003), (int) (this.alto * 0.003),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaF.add(BttnF);
		...
		BttnG.setBounds((int) (this.ancho * 0.789), (int) (this.alto * 0.003),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaF.add(BttnG);
		...
		BttnH.setBounds((int) (this.ancho * 0.393), (int) (this.alto * 0.375),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaF.add(BttnH);
		...
		BttnI.setBounds((int) (this.ancho * 0.003), (int) (this.alto * 0.747),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaF.add(BttnI);
		...
		BttnJ.setBounds((int) (this.ancho * 0.789), (int) (this.alto * 0.747),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaF.add(BttnJ);
		...
		BttnFEspacio.setBounds((int) (this.ancho * 0.3),
				(int) (this.alto * 0.003), (int) (this.ancho * 0.4),
				(int) (this.alto * 0.1));
		...
		BttnFPunto.setBounds((int) (this.ancho * 0.003),
				(int) (this.alto * 0.43), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		BttnFBorrar.setBounds((int) (this.ancho * 0.889),
				(int) (this.alto * 0.43), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		BttnFSI.setBounds((int) (this.ancho * 0.293),
				(int) (this.alto * 0.717), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		BttnFNO.setBounds((int) (this.ancho * 0.597),
				(int) (this.alto * 0.717), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		scrollPaneF
				.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		scrollPaneF.setBounds((int) (this.ancho * 0.25),
				(int) (this.alto * 0.879), (int) (this.ancho * 0.5),
				(int) (this.alto * 0.12));
		...
		txtF.setBounds((int) (this.ancho * 0.25), (int) (this.alto * 0.879),
				(int) (this.ancho * 0.5), (int) (this.alto * 0.12));
	...
	public void VentanaKConstructor() {
		...
		BttnK.setBounds((int) (this.ancho * 0.003), (int) (this.alto * 0.003),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaK.add(BttnK);
		...
		BttnL.setBounds((int) (this.ancho * 0.789), (int) (this.alto * 0.003),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaK.add(BttnL);
		...
		BttnM.setBounds((int) (this.ancho * 0.393), (int) (this.alto * 0.375),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaK.add(BttnM);
		...
		BttnN.setBounds((int) (this.ancho * 0.003), (int) (this.alto * 0.747),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaK.add(BttnN);
		...
		BttnNi.setBounds((int) (this.ancho * 0.789), (int) (this.alto * 0.747),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaK.add(BttnNi);
		...
		BttnKEspacio.setBounds((int) (this.ancho * 0.3),
				(int) (this.alto * 0.003), (int) (this.ancho * 0.4),
				(int) (this.alto * 0.1));
		...
		BttnKPunto.setBounds((int) (this.ancho * 0.003),
				(int) (this.alto * 0.43), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		BttnKBorrar.setBounds((int) (this.ancho * 0.889),
				(int) (this.alto * 0.43), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		BttnKSI.setBounds((int) (this.ancho * 0.293),
				(int) (this.alto * 0.717), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		BttnKNO.setBounds((int) (this.ancho * 0.597),
				(int) (this.alto * 0.717), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		scrollPaneK
				.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		scrollPaneK.setBounds((int) (this.ancho * 0.25),
				(int) (this.alto * 0.879), (int) (this.ancho * 0.5),
				(int) (this.alto * 0.12));
		...
		txtK.setBounds((int) (this.ancho * 0.25), (int) (this.alto * 0.879),
				(int) (this.ancho * 0.5), (int) (this.alto * 0.12));
	...
	public void VentanaOConstructor() {
		...
		BttnO.setBounds((int) (this.ancho * 0.003), (int) (this.alto * 0.003),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaO.add(BttnO);
		...
		BttnP.setBounds((int) (this.ancho * 0.789), (int) (this.alto * 0.003),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaO.add(BttnP);
		...
		BttnQU.setBounds((int) (this.ancho * 0.393), (int) (this.alto * 0.375),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaO.add(BttnQU);
		...
		BttnR.setBounds((int) (this.ancho * 0.003), (int) (this.alto * 0.747),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaO.add(BttnR);
		...
		BttnS.setBounds((int) (this.ancho * 0.789), (int) (this.alto * 0.747),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaO.add(BttnS);
		...
		BttnOEspacio.setBounds((int) (this.ancho * 0.3),
				(int) (this.alto * 0.003), (int) (this.ancho * 0.4),
				(int) (this.alto * 0.1));
		...
		BttnOPunto.setBounds((int) (this.ancho * 0.003),
				(int) (this.alto * 0.43), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		BttnOBorrar.setBounds((int) (this.ancho * 0.889),
				(int) (this.alto * 0.43), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		BttnOSI.setBounds((int) (this.ancho * 0.293),
				(int) (this.alto * 0.717), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		BttnONO.setBounds((int) (this.ancho * 0.597),
				(int) (this.alto * 0.717), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		scrollPaneO
				.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		scrollPaneO.setBounds((int) (this.ancho * 0.25),
				(int) (this.alto * 0.879), (int) (this.ancho * 0.5),
				(int) (this.alto * 0.12));
		...
		txtO.setBounds((int) (this.ancho * 0.25), (int) (this.alto * 0.879),
				(int) (this.ancho * 0.5), (int) (this.alto * 0.12));
	...
	public void VentanaTConstructor() {
		...
		BttnT.setBounds((int) (this.ancho * 0.003), (int) (this.alto * 0.003),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaT.add(BttnT);
		...
		BttnU.setBounds((int) (this.ancho * 0.789), (int) (this.alto * 0.003),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaT.add(BttnU);
		...
		BttnV.setBounds((int) (this.ancho * 0.393), (int) (this.alto * 0.375),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaT.add(BttnV);
		...
		BttnX.setBounds((int) (this.ancho * 0.003), (int) (this.alto * 0.747),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaT.add(BttnX);
		...
		BttnY.setBounds((int) (this.ancho * 0.789), (int) (this.alto * 0.747),
				(int) (this.ancho * 0.21), (int) (this.alto * 0.25));
		VentanaT.add(BttnY);
		...
		BttnTEspacio.setBounds((int) (this.ancho * 0.3),
				(int) (this.alto * 0.003), (int) (this.ancho * 0.4),
				(int) (this.alto * 0.1));
		...
		BttnTPunto.setBounds((int) (this.ancho * 0.003),
				(int) (this.alto * 0.43), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		BttnTBorrar.setBounds((int) (this.ancho * 0.889),
				(int) (this.alto * 0.43), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		BttnTSI.setBounds((int) (this.ancho * 0.293),
				(int) (this.alto * 0.717), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		...
		BttnTNO.setBounds((int) (this.ancho * 0.597),
				(int) (this.alto * 0.717), (int) (this.ancho * 0.11),
				(int) (this.alto * 0.14));
		VentanaT.add(BttnTNO);

		/*
		 * -- AREA DE TEXTO (VENTANA T) -- int indice_ultima_linea =
		 * JTextArea_variable.getDocument().getLength(); //retorna el numero de
		 * lineas JTextArea_variable.setCaretPosition(indice_ultima_linea);
		 * //ubica el cursor al final
		 */
		JScrollPane scrollPaneT = new JScrollPane(txtT);
		scrollPaneT
				.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		scrollPaneT.setBounds((int) (this.ancho * 0.25),
				(int) (this.alto * 0.879), (int) (this.ancho * 0.5),
				(int) (this.alto * 0.12));
		...
		txtT.setBounds((int) (this.ancho * 0.25), (int) (this.alto * 0.879),
				(int) (this.ancho * 0.5), (int) (this.alto * 0.12));
	...
	static public void CrearArchivo() {
		if (NroArchivo < 10) {
			ArchivoTexto = new File(Speak.path() + "Textos\\Archivo00"
					+ NroArchivo + ".txt");
		} else if (NroArchivo < 100) {
			ArchivoTexto = new File(Speak.path() + "Textos\\Archivo0"
					+ NroArchivo + ".txt");
		} else if (NroArchivo < 1000) {
			ArchivoTexto = new File(Speak.path() + "Textos\\Archivo"
					+ NroArchivo + ".txt");
		}
		NroArchivo++;
